...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url();?>user/Home" class="logo">
      ...
      <span class="logo-lg"><b>PERPUS</b>DUADUA</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              foreach ($log as $key => $value) {
                ?>
              <img src="<?php echo base_url(); ?>gambar_user/<?php echo $value->img;?>" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              foreach ($log as $key => $value) {
                ?>
                <img src="<?php echo base_url(); ?>gambar_user/<?php echo $value->img;?>" class="img-circle" alt="User Image">

                <p>
                  <?php echo $value->nama;?>
                  <small>user Perpus</small>
                </p>
                <?php
              }
              ?>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url(); ?>user/Anggota"><i class="fa fa-user"></i>Data Anggota</a></li>
            <li><a href="<?php echo base_url(); ?>user/Kelas"><i class="fa fa-building-o"></i>Data Kelas</a></li>
             <li><a href="<?php echo base_url(); ?>user/Agama"><i class="fa fa-moon-o"></i>Data Agama</a></li>
          </ul>
        </li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url();?>user/Buku/Buku"><i class="fa fa-book"></i>Data Buku</a></li>
            <li><a href="<?php echo base_url(); ?>user/Kategori"><i class="fa fa-tags"></i>Data Kategori</a></li>
             <li><a href="<?php echo base_url(); ?>user/Rak"><i class="fa fa-archive"></i>Data Rak</a></li>
             <li><a href="<?php echo base_url(); ?>user/Pengarang"><i class="fa fa-pencil-square-o"></i>Data Pengarang</a></li>
              <li><a href="<?php echo base_url(); ?>user/Penerbit"><i class="fa fa-user-secret"></i>Data Penerbit</a></li>
              <li><a href="<?php echo base_url(); ?>user/Provinsi"><i class="fa fa-globe"></i>Data Provinsi</a></li>
          </ul>
        </li>
        <li class="header">Transaksi</li>
         <li class="treeview">
          ...
          <ul class="treeview-menu">
              <li><a href="<?php echo base_url(); ?>user/Pinjam"><i class="fa fa-book"></i>Data Peminjaman</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
              <li><a href="<?php echo base_url(); ?>user/Report"><i class="fa fa-book"></i>Buku Report</a></li>
              <li><a href="<?php echo base_url(); ?>user/Report/pengembalian"><i class="fa fa-book"></i>Report Pengembalian</a></li>
          </ul>
        </li>
        <li class="header">DENDA</li>
        <li><a href="<?php echo base_url();?>user/Denda"><i class="fa fa-usd"></i> <span>Denda</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url(); ?>user/<?php echo $pointer; ?>""><i class="<?php echo $classicon; ?>"></i><?php echo $main_bread; ?></a></li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2020 <a href="http://mtsn22jkt.sch.id/">MTsN 22 Jakarta</a>.</strong> All rights reserved.
  </footer>
...
$(document).ready(function() {
     $('#table-user1').DataTable( {
       ...
       var table = $('#table-user1').DataTable();
      $('#table-user1 tbody').on('click', 'td.details-control', function () {
        var tr = $(this).closest('tr');
        var row = table.row( tr );
        ...
        if ( row.child.isShown() ) {
            ...
            // Open this row
            row.child( format_user(row.data()) ).show();
            tr.addClass('shown');
        }
    } );
  } );
