...
<body>
            ...
            <nav class="teal lighten-1">
                <div class="container">
                        ...
                        <div class="nav-wrapper">
                            <a href="<?php echo base_url();?>Buku" class="brand-logo"><img src="<?php echo base_url(); ?>assets2/img/logo.png" width="45px" alt=""></a>
                            <ul class="right hide-on-med-and-down">
                                ...
                                <li><a class="btn blue" href="<?php echo base_url();?>/web/log">MASUK</a></li>
                            </ul>
                        </div>
                </div>
            </nav>
    ...
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <h3 class="header center white-text text-lighten-2 z-depth-5">Sistem Perpustakaan MTsN 22 Jakarta</h3>
       

      </div>
    </div>
    <div class="parallax"><img src="<?php echo base_url(); ?>assets2/img/duadua.jpg" alt="Unsplashed background img 1"></div>
  </div>
  <!-- Slider end -->
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                     &copy; : <a href="http://mtsn22jkt.sch.id/" target="_blank">MTsN 22 Jakarta</a>
                </div>
