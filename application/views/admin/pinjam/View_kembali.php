...
<div class="box box-solid box-info">
  ...
  <div class="btn-group">
   ...
   <div class="box-body">
   <div class="btn-group"><a href="<?php echo base_url(); ?>admin/Pinjam/create"  class="btn btn-info" role="button" data-toggle="tooltip" title="Tambah Peminjaman"><i class="fa fa-plus"></i>Tambah Peminjaman</a></div>
