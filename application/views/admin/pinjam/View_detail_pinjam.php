...
<div class="box box-solid box-info">
  <div class="box-header with-border">
   ...
   <div class="box-body">
   <div class="btn-group">
   <a href="<?php echo base_url(); ?>admin/Pinjam/createdet"  class="btn btn-info" role="button" data-toggle="tooltip" title="Tambah Data Detail Stok  Buku"><i class="fa fa-plus"></i>Tambah Detail Pinjam</a></div>
   <!--div class="btn-group">
