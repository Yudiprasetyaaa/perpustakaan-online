...
<div class="wrapper">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              foreach ($log as $key => $value) {
                ...
                <p>
                  <?php echo $value->nama;?>
                  <small>Admin Perpus MTsN 22 Jakarta</small>
                </p>
                <?php
              }
              ?>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="<?php echo base_url();?>admin/Denda"><i class="fa fa-usd"></i> <span>Denda</span></a></li>
         <li class="header">ADMIN/SISWA</li>
        <li><a href="<?php echo base_url();?>admin/Petugas"><i class="fa fa-user-plus"></i> <span>Akses Petugas</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong><a href="http://mtsn22jkt.sch.id/">MTsN 22 Jakarta</a></strong> 
  </footer>
...
<script>
  $(function () {
    ...
    var barChartData = areaChartData3;
 //  barChartData.datasets[0].fillColor = "<?php echo '#'.substr(str_shuffle('ABCDEF0123456789'),0,6) ;?>";
    barChartData.datasets[0].fillColor = "#5F9EA0";
    barChartData.datasets[0].strokeColor = "#5F9EA0";
    barChartData.datasets[0].pointColor = "#5F9EA0";
    var barChartOptions = {
      //Boolean - Whether the scale should start at zero, or an order of magnitude down from the lowest value
      scaleBeginAtZero: true,
      //Boolean - Whether grid lines are shown across the chart
