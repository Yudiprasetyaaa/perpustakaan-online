...
<div class="box box-solid box-info">
  <div class="box-header with-border">
   ...
   <div class="box-body">
   <div class="btn-group"><a href="<?php echo base_url(); ?>admin/Penerbit/create"  class="btn btn-info" role="button" data-toggle="tooltip" title="Tambah Penerbit"><i class="fa fa-plus"></i>  Tambah Penerbit</a></div>
