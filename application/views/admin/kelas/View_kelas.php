...
<div class="box box-solid box-info">
  <div class="box-header with-border">
   ...
   <div class="box-body">
   <div class="btn-group"><a href="<?php echo base_url(); ?>admin/Kelas/create"  class="btn btn-info" role="button" data-toggle="tooltip" title="Tambah Kelas"><i class="fa fa-plus"></i>  Tambah Kelas</a></div>
   ...
   <table id="example2" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <tbody>
         <?php
  $no = 1;
    foreach($kelas->result_array() as $op)
    {
    ?>
            <tr>
                <td><?php echo $no++ ;?></td>
                ...
                <?php echo 
                    '<div class="btn-group">
                     <a href="'.base_url().'admin/Kelas/edit/?kelas='.$op['kelas'].'" class="btn btn-warning" role="button" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                     &nbsp&nbsp
                    <span data-toggle="modal" data-target="#confirm-delete" data-href="'.base_url().'admin/Kelas/delete/?kelas='.$op['kelas'].'">
