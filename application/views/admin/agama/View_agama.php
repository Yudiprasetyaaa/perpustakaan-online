...
<div class="box box-solid box-info">
  <div class="box-header with-border">
   ...
   <div class="box-body">
   <div class="btn-group"><a href="<?php echo base_url(); ?>admin/Agama/create"  class="btn btn-info" role="button" data-toggle="tooltip" title="Tambah Agama"><i class="fa fa-plus"></i>  Tambah Agama</a></div>
