...
<div class="box box-solid box-info">
  <div class="box-header with-border">
   ...
   <div class="box-body">
   <div class="btn-group"><a href="<?php echo base_url(); ?>admin/Buku/tambah_det_buku/?id_buku=<?php echo $id;?>"  class="btn btn-info" role="button" data-toggle="tooltip" title="Tambah Data Detail Stok Buku"><i class="fa fa-plus"></i>Tambah Detail Stok</a></div>
    ...
    ?>
            <tr>
                ...
                <?php
                    echo 
                    '<div class="btn-group">
                     <a href="'.base_url().'admin/Buku/edit_det_buku/?id_detail_buku='.$op['id_detail_buku'].'&id_buku='.$op['id_buku'].'" class="btn btn-warning" role="button" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>';
                     if($op['status']==1){
                      echo
                    '&nbsp<span data-toggle="modal" data-target="#confirm-delete" data-href="'.base_url().'admin/Buku/hapus_det_buku/?id_detail_buku='.$op['id_detail_buku'].'&id_buku='.$op['id_buku'].'">
