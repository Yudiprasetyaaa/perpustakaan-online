...
<div class="box box-solid box-info">
  <div class="box-header with-border">
   ...
   <div class="box-body">
   <div class="btn-group"><a href="<?php echo base_url(); ?>admin/Denda/create"  class="btn btn-info" role="button" data-toggle="tooltip" title="Tambah Denda"><i class="fa fa-plus"></i>  Tambah Denda</a></div>
