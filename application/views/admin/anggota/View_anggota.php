  ...
  $no = 1;
    ...
    ?>
            <tr>
                ...
                <?php echo 
                    '<div class="btn-group">
                     <a href="'.base_url().'admin/Anggota/edit/?id_siswa='.$op['id_siswa'].'" class="btn btn-warning" role="button" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>&nbsp
                    <span data-toggle="modal" data-target="#confirm-delete" data-href="'.base_url().'admin/Anggota/delete/?id_siswa='.$op['id_siswa'].'">
