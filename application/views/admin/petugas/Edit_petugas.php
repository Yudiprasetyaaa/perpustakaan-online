...
<div class="box box-solid box-info">
  <div class="box-header with-border">
    <h3 class="box-title"><i class="fa fa-pencil"></i> <i class="fa fa-book"></i>Edit Akses</h3>
  ...
  <div class="box-footer">
    Update Data Akses Petugas Perpustakaan, edit form diatas untuk mengubah data Petugas. 
  </div><!-- box-footer -->
</div><!-- /.box -->
