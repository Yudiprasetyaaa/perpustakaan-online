...
<div class="box box-solid box-info">
	...
	<form class="form-horizontal" method="post"  <?php echo form_open_multipart('admin/Petugas/Create');?>
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control" name="id_petugas" placeholder="Nomor Induk Petugas(sebagai Username login)" required="required" >
                  </div>
                </div>
                 <div class="form-group">
  ...
  <div class="box-footer">
    Menambah Data Akses Petugas Perpustakaan, isi form diatas untuk menambahkan data Akses. 
  </div><!-- box-footer -->
</div><!-- /.box -->
