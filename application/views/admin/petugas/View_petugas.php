...
<div class="box box-solid box-info">
  <div class="box-header with-border">
    <h3 class="box-title"><i class="fa fa-book"></i> Daftar Akses Petugas</h3>
   ...
   <div class="box-body">
   <div class="btn-group"><a href="<?php echo base_url(); ?>admin/Petugas/create"  class="btn btn-info" role="button" data-toggle="tooltip" title="Tambah Akses"><i class="fa fa-plus"></i>  Tambah Akses</a></div>
...
<?php
  ...
  <div class="box-footer">
    Menampilkan daftar Akses Petugas, untuk melihat detail Akses Petugas klik tombol +, mengedit dan menghapus Akses Petugas klik tombol pada kolom pilihan.
  </div><!-- box-footer -->
</div><!-- /.box -->
