...
<div class="box box-solid box-success">
  <div class="box-header with-border">
   ...
   <div class="box-body">
   <div class="btn-group"><a href="<?php echo base_url(); ?>petugas/Pinjam/createdet"  class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Data Detail Stok Buku"><i class="fa fa-plus"></i>Tambah Detail Pinjam</a></div>
