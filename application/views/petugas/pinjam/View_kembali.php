  ...
  $no = 1;
    ...
    ?>
            <tr>
                ...
                <?php echo 
                  '<div class="btn-group">
                    <a href="'.base_url().'petugas/Kembali/vw_dt_back/?id_pinjam='.$op['id_pinjam'].'" class="btn btn-info" role="button" data-toggle="tooltip" title="Detail Kembali"><i class="fa fa-list"></i></a>
                    </div>
                    <span data-toggle="modal" data-target="#confirm-delete" data-href="'.base_url().'petugas/Pinjam/hapus_kembali/?id_pinjam='.$op['id_pinjam'].'">
