...
<div class="box box-solid box-success">
  <div class="box-header with-border">
   ...
   <div class="box-body">
   <div class="btn-group"><a href="<?php echo base_url(); ?>petugas/Denda/create"  class="btn btn-success" role="button" data-toggle="tooltip" title="Tambah Denda"><i class="fa fa-plus"></i>  Tambah Denda</a></div>
  ...
  $no = 1;
    ...
    ?>
            <tr>
                ...
                <?php echo 
                    '<div class="btn-group">
                     <a href="'.base_url().'petugas/Denda/edit/?id_denda='.$op['id_denda'].'" class="btn btn-warning" role="button" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                     &nbsp&nbsp
                    <span data-toggle="modal" data-target="#confirm-delete" data-href="'.base_url().'petugas/Denda/delete/?id_denda='.$op['id_denda'].'">
