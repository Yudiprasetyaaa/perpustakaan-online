...
class Petugas extends MY_Controller {
	...
	public function index(){
		...
		{
			/*layout*/	
			$data['title']='Daftar Akses petugas';
			$data['pointer']="Akses petugas";
			$data['classicon']="fa fa-book";
			$data['main_bread']="Data Akses petugas";
			$data['sub_bread']="Daftar Akses petugas";
			$data['desc']="Data Master Akses Petugas, Menampilkan data Akses Petugas Perpustakaan";
